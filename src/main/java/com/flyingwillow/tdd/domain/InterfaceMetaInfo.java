...
public class InterfaceMetaInfo {
    ...
    public InterfaceMetaInfo(Module module, PsiJavaFile javaFile, InterfaceNameReader reader, PsiClass cls) {
    ...
    public InterfaceMetaInfo(Module module, PsiMethod method, PsiClass javaClass, InterfaceNameReader reader) {
        this.project = module.getProject();
        this.module = module;
    ...
    public InterfaceMetaInfo(Module module, String packageName, List<PsiJavaFile> javaFiles, InterfaceNameReader reader) {
        this.project = module.getProject();
        this.module = module;
